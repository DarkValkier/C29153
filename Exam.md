...
Пример метода \_\_str\_\_ для класса [Character](https://github.com/DarkValkier/C29153/blob/master/Lesson_3/character.py#L13):
```python
def __str__(self):
        return \
            f' === {self.name} ===\n' \
...
Для каждой ошибки в методе `change_state` создать отдельный класс, унаследованный от класса Exception (аналогично классу [CarNotEnoughFuel](https://github.com/DarkValkier/C29153/blob/master/Lesson_5/car.py#L1) из [пятого урока](https://github.com/DarkValkier/C29153/tree/master/Lesson_5)).
